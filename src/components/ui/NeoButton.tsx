  ...
  ({
    ...
    const colorStyle =
      variant === "white"
        ...
        : variant === "secondary"
        ? "bg-[#FF90E8] hover:bg-[#ff7ae4]"
        : variant === "accent"
        ? "bg-accent text-white hover:bg-[#1b8278]"
        : variant === "black"
    ...
    const hoverEffect = disabled
      ? ""
      : "hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none active:translate-x-[4px] active:translate-y-[4px] active:shadow-none";
